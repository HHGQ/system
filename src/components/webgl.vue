<template>
  ...
  <div>
    ...
    <!-- <img src="../assets/logo.png" alt="" style="position:absolute;"> -->
    <canvas id="canvas-container" width="800px" height="500px" style="position:absolute;z-index:1"></canvas>
  </div>
</template>
    ...
    methods: {
      beforeUpload(file) {
        ...
        reader.onload = function(){
          ...
          // const mat4 YUV2RGB方法里的最后一个1改为0，则可以隐藏黑色
          const fragmentShaderScript420 = `
            ...
            const mat4 YUV2RGB = mat4(
                ...
                4.1643828125, 2.017234375, 0, -1.081390625,
                0, 0, 0, 0
            ); 
          ...
          const yDatas = buffer.subarray(16, yLen)
          // console.log(yData)
          // console.log(yDatas)
          // console.log(concatenate(Uint8Array, yData, yDatas))
          // y分量中0为纯黑色，255为纯白色
          for(let i = 0 ; i< yData.length - 300000;i++) {
            yData[i] = 0
          }
          ...
          // 若只有y分量，则u和v都为128，就可正常渲染黑白色，否则不是纯黑白
