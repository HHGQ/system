...
// 直接Import 不兼容 vue2，所以直接在index.html引入js

export default {
  mounted() {
    Cesium.Ion.defaultAccessToken =
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJiOTc0ZTQzNi04ZjEyLTQwNWQtYTA4Mi05MTUyNzJjMjg0OTEiLCJpZCI6MTQ2NDQ2LCJpYXQiOjE2ODY2MTg1Nzd9.nfkteQB77f4YdPXqDowNDQgr4eYRDyHaSj53JKuhlk0";
        // this.init();
        this.init2()
  },
  methods: {
    ...
    init2() {
      ...
      var tileset = new Cesium.Cesium3DTileset({
        url: "https://cesium.com/downloads/cesiumjs/releases/1.83/Tilesets/EarthCesium3DTiles/tileset.json",
